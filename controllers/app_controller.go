...
import (
	...
	flydemov1beta1 "github.com/kubebuilder-demo/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=flydemo.demo.kubebuilder.io,resources=apps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=flydemo.demo.kubebuilder.io,resources=apps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=flydemo.demo.kubebuilder.io,resources=apps/finalizers,verbs=update
